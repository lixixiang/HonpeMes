...
public class DateUtil {
    ...
    public static SimpleDateFormat strYMD = new SimpleDateFormat("yyyy年MM月dd日");
    public static SimpleDateFormat strYM = new SimpleDateFormat("yyyy年MM月");
    public static SimpleDateFormat strMD = new SimpleDateFormat("MM月dd日");
    public static SimpleDateFormat strYMDhm = new SimpleDateFormat("yyyy年MM月dd日 HH:mm");
    public static SimpleDateFormat strMDhm = new SimpleDateFormat("MM月dd日 HH:mm");
    public static SimpleDateFormat y_m_d = new SimpleDateFormat("yyyy.MM.dd");
    public static SimpleDateFormat m_d_hm = new SimpleDateFormat("MM.dd HH:mm");
    ...
    public static SimpleDateFormat numymd = new SimpleDateFormat("yyyyMMdd");
    public static SimpleDateFormat y = new SimpleDateFormat("yyyy");
    public static SimpleDateFormat m = new SimpleDateFormat("MM");
    public static SimpleDateFormat y_m_dhms = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
    ...
    public static String timeStamp2Date(SimpleDateFormat sf, long time) {
        if (time == 0) {
            return "";
        }
     ...
     * @return
     */
    public static String getCurrentLastDayOfMonth(SimpleDateFormat sf) {
     ...
     * @return
     */
    public static String getCurrentLastDayOfMonth(SimpleDateFormat sf, String lastDay) {
        Date date = setDate(sf, lastDay);
        Calendar ca = Calendar.getInstance();
        ca.setTime(date);
        ca.set(Calendar.DAY_OF_MONTH, ca.getActualMaximum(Calendar.DAY_OF_MONTH));
        String last = sf.format(ca.getTime());
     ...
     * @return
     */
    public static String getIndexDateBeforeLast(String indexDate, SimpleDateFormat sf, int n) {
        Date date = setDate(sf, indexDate);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @return
     */
    public static String getIndexTimeBeforeLast(String indexDate, SimpleDateFormat sf, int n) {
        Date date = setDate(sf, indexDate);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
    ...
    public static String getLastDayOfMonth(int month) {
        ...
        return DateUtil.ymd.format(calendar.getTime());
    }
    ...
    public static String getLastMonth(SimpleDateFormat dft, int date) {
        Calendar cal = Calendar.getInstance();
        cal.add(cal.MONTH, date);
        String lastMonth = dft.format(cal.getTime());
        return lastMonth;
     ...
     * @return 1'5" 转秒
     */
    public static int MinuteSecondToSecond(String time) {
        int total = 0;
        if (time.contains("'")) {
            String minute = time.substring(0, time.indexOf("'"));//获取某个字符前面的字符串
            String second = time.substring(time.indexOf("'") + 1, time.indexOf("\""));//获取从某个字符到某个字符之间的值
            total = Integer.parseInt(minute) * 60 + Integer.parseInt(second);
        } else if (time.contains("\"") && !time.contains("'")) { //只有秒，没有分钟
            String second = time.substring(0, time.indexOf("\""));
    ...
    public static List<String> getTimes(SimpleDateFormat sdf, String startTime, String endTime) {
    ...
    public static String dateToWeek(SimpleDateFormat sdf, String dateTime) {
        String[] weekDays = {"星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"};
        Calendar calendar = Calendar.getInstance(); //获得一个日历
        Date date = null;
        try {
...
//		c.set(Calendar.DATE, day - 1);
     ...
     * @return
     */
    public static int compare_date(SimpleDateFormat sdf, String DATE1, String DATE2) {
        int a = 0;
        try {
     ...
     * @return
     */
    public static String getFristDayOfLastMonth(SimpleDateFormat sf, Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.set(calendar.get(Calendar.YEAR),
                calendar.get(Calendar.MONTH), -1);
     ...
     * @return
     */
    public static String getLastDayOfLastMonth(SimpleDateFormat sf, Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.set(calendar.get(Calendar.YEAR),
    ...
    public static String getTimePoor(long time) {
        String timeDifference = "";

        long hours = time / 3600;  // 获取小时数
        long minutes = (time % 3600) / 60;  // 获取剩余分钟数
        long seconds = time % 60;  // 获取剩余秒数
        timeDifference = String.format("%02d时%02d分%02d秒", hours, minutes, seconds);
     ...
     * @return
     */
    public static String getTimePoor(Date endDate, Date startTime) {
        String timeDifference = "";

        long diffInMillis = endDate.getTime() - startTime.getTime();
    ...
    public static String CountTMS(long diff) {
        String time = null;

        LatteLogger.d("testCountTMS",diff);
    ...
    public static String getWeek(SimpleDateFormat sdf, String strDate) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(setDate(sdf, strDate));
        int week_index = cal.get(Calendar.DAY_OF_WEEK) - 1;
        if (week_index < 0) {
            week_index = 0;
        }
        return dayNames[week_index];
    }
     ...
     */
    public static boolean isValidDate(SimpleDateFormat sdf, String str) {
    ...
    public static String getYearFirstDay() {
        ...
        // 获取全年第一天
        Date firstDayOfYear = getFirstDayOfYear(currentYear);
        String formattedFirstDay = DateUtil.ymd.format(firstDayOfYear);
    ...
    public static String getYearLastDay() {
        ...
        int currentYear = Calendar.getInstance().get(Calendar.YEAR);
        // 获取全年第一天
        Date lastDayOfYear = getLastDayOfYear(currentYear);
        String formattedLastDay = DateUtil.ymd.format(lastDayOfYear);
