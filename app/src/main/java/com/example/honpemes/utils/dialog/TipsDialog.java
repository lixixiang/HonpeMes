...
/**
 * Created by Lixixiang on 2023/3/1 14:00
 */
public class TipsDialog extends AlertDialog {
    ...
    protected TipsDialog(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
    ...
    protected void setDialogButton(int whichButton, String text, final View.OnClickListener listener) {
     ...
     * @return PopupDialog
     */
    public static TipsDialog create(Context context, String title, String message, String confirm, View.OnClickListener
        ...
        TipsDialog dialog = new TipsDialog(context, cancelable, canceledOnTouchOutside);
     ...
     * @return PopupDialog
     */
    public static TipsDialog create(Context context, int titleRes, int messageRes, int confirmRes, View.OnClickListener
