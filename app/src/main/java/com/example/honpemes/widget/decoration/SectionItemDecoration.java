package com.example.honpemes.widget.decoration;
...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    private List<UseInfoBean.DataBean> mData;
    ...
    public SectionItemDecoration(Context context, List<UseInfoBean.DataBean> data) {
        this.mData = data;
        TypedValue typedValue = new TypedValue();

        context.getTheme().resolveAttribute(R.attr.cpSectionBackground, typedValue, true);
        mBgColor = context.getResources().getColor(R.color.grey_l_l_l_l);

        context.getTheme().resolveAttribute(R.attr.cpSectionHeight, typedValue, true);
        mSectionHeight = context.getResources().getDimensionPixelSize(R.dimen._36dp);

        context.getTheme().resolveAttribute(R.attr.cpSectionTextSize, typedValue, true);
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen._16sp);

        context.getTheme().resolveAttribute(R.attr.cpSectionTextColor, typedValue, true);
        mTextColor = context.getResources().getColor(R.color.grey_l);
    ...
    public void setData(List<UseInfoBean.DataBean> data) {
        this.mData = data;
    }
