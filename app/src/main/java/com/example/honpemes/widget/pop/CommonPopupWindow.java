package com.example.honpemes.widget.pop;
...
public class CommonPopupWindow extends PopupWindow {
    ...
    //显示控件下方
    public void showDownView(View view,int xoff,int yoff) {
        this.showAsDropDown(view, (-(this.getWidth() - view.getMeasuredWidth()) / 2) -xoff, yoff);
    }
    ...
    public void setBackgroundAlpha(Activity activity, float bgAlpha) {
        ...
        setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(activity, R.color.grey_alpha4)));
