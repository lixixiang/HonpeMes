package com.example.honpemes.widget.view;
...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.blue_l));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.blue_l));
        } else {
