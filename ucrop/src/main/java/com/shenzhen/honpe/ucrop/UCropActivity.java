package com.shenzhen.honpe.ucrop;
...
import com.shenzhen.honpe.ucrop.callback.BitmapCropCallback;
import com.shenzhen.honpe.ucrop.immersion.CropImmersiveManage;
import com.shenzhen.honpe.ucrop.model.AspectRatio;
import com.shenzhen.honpe.ucrop.util.FileUtils;
import com.shenzhen.honpe.ucrop.util.MimeType;
import com.shenzhen.honpe.ucrop.util.ScreenUtils;
import com.shenzhen.honpe.ucrop.util.SelectedStateListDrawable;
import com.shenzhen.honpe.ucrop.view.CropImageView;
import com.shenzhen.honpe.ucrop.view.GestureCropImageView;
import com.shenzhen.honpe.ucrop.view.OverlayView;
import com.shenzhen.honpe.ucrop.view.TransformImageView;
import com.shenzhen.honpe.ucrop.view.UCropView;
import com.shenzhen.honpe.ucrop.view.widget.AspectRatioTextView;
import com.shenzhen.honpe.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private void getCustomOptionsData(@NonNull Intent intent) {
        ...
        mStatusBarColor = intent.getIntExtra(UCrop.Options.EXTRA_STATUS_BAR_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_black));
        mToolbarColor = intent.getIntExtra(UCrop.Options.EXTRA_TOOL_BAR_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_black));
        if (mToolbarColor == 0) {
            mToolbarColor = ContextCompat.getColor(this, R.color.ucrop_color_black);
        }
        if (mStatusBarColor == 0) {
            mStatusBarColor = ContextCompat.getColor(this, R.color.ucrop_color_black);
        }
    }
